...
void test_locale_wchar_t_1()
{
    ...
    {
        if (!loc.has<IOv2::ctype_conf<wchar_t>>()) throw std::runtime_error("locale::has error");
    ...
    {
        if (loc_r.has<IOv2::ctype_conf<wchar_t>>()) throw std::runtime_error("locale::has error");
...
void test_locale_wchar_t_3()
{
    ...
    {
        if (!loc1.has<IOv2::ctype<wchar_t>>()) throw std::runtime_error("locale::has error");
    ...
    {
        if (loc2.has<IOv2::ctype<wchar_t>>()) throw std::runtime_error("locale::has error");
    ...
    {
        if (!loc3.has<IOv2::ctype<wchar_t>>()) throw std::runtime_error("locale::has error");
...
void test_locale_wchar_t_5()
{
    ...
    if (ptr2->m_obj1 != loc1.get<IOv2::ctype_conf<wchar_t>>()) throw std::runtime_error("locale::get error");
    if (ptr2->m_obj2 != loc1.get<IOv2::collate_conf<wchar_t>>()) throw std::runtime_error("locale::get error");
...
void test_locale_wchar_t_6()
{
    ...
    auto loc1 = IOv2::locale<wchar_t>("en_US.UTF-8");
    {
        ...
        if (ptr->m_obj1 != loc1.get<IOv2::timeio_conf<wchar_t>>()) throw std::runtime_error("locale::get error");
...
void test_locale_wchar_t_7()
{
    ...
    
    {
        ...
        if (loc2.has<IOv2::timeio<wchar_t>>()) throw std::runtime_error("locale::has error");
