...
void test_locale_char8_t_1()
{
    ...
    {
        if (!loc.has<IOv2::ctype_conf<char8_t>>()) throw std::runtime_error("locale::has error");
        auto obj = loc.get<IOv2::ctype_conf<char8_t>>();
    ...
    {
        if (loc_r.has<IOv2::ctype_conf<char8_t>>()) throw std::runtime_error("locale::has error");
        auto obj = loc_r.get<IOv2::ctype_conf<char8_t>>();
        if (obj) throw std::runtime_error("locale::get error");
    }
...
{
    dump_info("Test locale<char8_t> case 2...");
...
{
    dump_info("Test locale<char8_t> case 3...");
    
    auto loc1 = IOv2::locale<char8_t>("zh_CN.UTF-8");
    {
        if (!loc1.has<IOv2::ctype<char8_t>>()) throw std::runtime_error("locale::has error");
    ...
    auto loc2 = loc1.remove<IOv2::ctype_conf<char8_t>>();
    {
        if (loc2.has<IOv2::ctype<char8_t>>()) throw std::runtime_error("locale::has error");
        auto p1 = loc2.get<IOv2::ctype<char8_t>>();
        if (p1) throw std::runtime_error("locale::get error");
    }
    
    auto loc3 = loc2.involve(std::make_shared<IOv2::ctype_conf<char8_t>>("zh_CN.UTF-8"));
    {
        if (!loc3.has<IOv2::ctype<char8_t>>()) throw std::runtime_error("locale::has error");
        auto p1 = loc3.get<IOv2::ctype<char8_t>>();
        if (!p1) throw std::runtime_error("locale::get error");
    }
...
{
    dump_info("Test locale<char8_t> case 4...");
    ...
    auto loc2 = loc1.remove<IOv2::collate_conf<char8_t>>();
    {
...
{
    dump_info("Test locale<char8_t> case 5...");
    ...
    if (ptr2->m_obj1 != loc1.get<IOv2::ctype_conf<char8_t>>()) throw std::runtime_error("locale::get error");
    if (ptr2->m_obj2 != loc1.get<IOv2::collate_conf<char8_t>>()) throw std::runtime_error("locale::get error");
...
{
    dump_info("Test locale<char8_t> case 6...");
    ...
    auto loc1 = IOv2::locale<char8_t>("en_US.UTF-8");
    {
        ...
        if (ptr->m_obj1 != loc1.get<IOv2::timeio_conf<char8_t>>()) throw std::runtime_error("locale::get error");
...
{
    dump_info("Test locale<char8_t> case 7...");
    
    {
        auto loc1 = IOv2::locale<char8_t>("en_US.UTF-8");
        auto loc2 = loc1.remove<IOv2::timeio_conf<char8_t>>();
        
        if (loc2.has<IOv2::timeio<char8_t>>()) throw std::runtime_error("locale::has error");
        auto ptr = loc2.get<IOv2::timeio<char8_t>>();
        if (ptr) throw std::runtime_error("locale::get error");
        
        if (!loc2.has<IOv2::ctype<char8_t>>()) throw std::runtime_error("locale::has error");
        auto ptr2 = loc2.get<IOv2::ctype<char8_t>>();
        if (!ptr2) throw std::runtime_error("locale::get error");
    }
...
{
    dump_info("Test locale<char8_t> case 9...");
    ...
    VERIFY(msg->translate(u8"please") == ref1);
    VERIFY(msg->translate(u8"thank you") == ref2);
    VERIFY(msg->translate(u8"") == u8"");
    VERIFY(msg->head_entry() != u8"");
...
{
    dump_info("Test locale<char8_t> case 10...");
    ...
    VERIFY(msg->translate(u8"please") == u8"please");
    VERIFY(msg->translate(u8"thank you") == u8"thank you");
    VERIFY(msg->translate(u8"") == u8"");
    VERIFY(msg->head_entry() == u8"");
