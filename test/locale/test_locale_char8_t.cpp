...
void test_locale_char8_t_1()
{
    ...
    {
        VERIFY(loc.has<IOv2::ctype_conf<char8_t>>());
    ...
    {
        VERIFY(!(loc_r.has<IOv2::ctype_conf<char8_t>>()));
...
void test_locale_char8_t_3()
{
    ...
    {
        VERIFY(loc1.has<IOv2::ctype<char8_t>>());
    ...
    {
        VERIFY(!(loc2.has<IOv2::ctype<char8_t>>()));
    ...
    {
        VERIFY(loc3.has<IOv2::ctype<char8_t>>());
...
void test_locale_char8_t_5()
{
    ...
    VERIFY(ptr2->m_obj1 == loc1.get<IOv2::ctype_conf<char8_t>>());
    VERIFY(ptr2->m_obj2 == loc1.get<IOv2::collate_conf<char8_t>>());
...
void test_locale_char8_t_6()
{
    ...
    auto loc1 = IOv2::locale<char8_t>("en_US.UTF-8");
    {
        ...
        VERIFY(ptr->m_obj1);
        VERIFY(ptr->m_obj1 == loc1.get<IOv2::timeio_conf<char8_t>>());
        VERIFY(!(ptr->m_obj2));
        VERIFY(!(ptr->m_obj3));
    }
...
void test_locale_char8_t_7()
{
    ...
    
    {
        ...
        VERIFY(!(loc2.has<IOv2::timeio<char8_t>>()));
