...
| `valgrind-common` | 使用 valgrind 构建并运行 common 测试 |
...
| `common` | Build common tests only |
...
| `test-common` | Build and run common tests |
...
| `valgrind-common` | Build and run common tests with valgrind |
