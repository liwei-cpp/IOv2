...
{
    dump_info("Test istream<wchar_t> operator>> (arithmetic) case 1...");
...
//        int* pi = &j;
//
// comment out since this one does not work for the current gcc compiler
//        IOv2::ostream ss_01{IOv2::mem_device{L""}, IOv2::locale<wchar_t>("C")};
//        ss_01 << po;
...
{
    dump_info("Test istream<wchar_t> operator>> (arithmetic) case 2...");

    auto helper = []<template<typename, typename> class T>()
    {
        const std::wstring str_01(L"20000AB");
        T is(IOv2::mem_device{str_01}, IOv2::locale<wchar_t>("C"));
...
void test_istream_extractors_arithmetic_wchar_t_3()
{
    dump_info("Test istream<wchar_t> operator>> (arithmetic) case 3...");

    auto helper = []<template<typename, typename> class T>()
    {
        IOv2::ostream ostr(IOv2::mem_device{L""}, IOv2::locale<wchar_t>("C"));
        ostr << L"12220101";
...
void test_istream_extractors_arithmetic_wchar_t_4()
{
    dump_info("Test istream<wchar_t> operator>> (arithmetic) case 4...");
...
namespace
{
    class test_numpunct1 : public IOv2::numeric_conf<wchar_t>
    {
    public:
        test_numpunct1()
...
void test_istream_extractors_arithmetic_wchar_t_5()
{
    dump_info("Test istream<wchar_t> operator>> (arithmetic) case 5...");
    auto helper = []<template<typename, typename> class T>()
    {
        ...
        T is(IOv2::mem_device{s1}, IOv2::locale<wchar_t>("C"));
        is.locale(IOv2::locale<wchar_t>("C").involve(std::make_shared<test_numpunct1>()));
...
namespace
{
    class test_numpunct2 : public IOv2::numeric_conf<wchar_t>
    {
    public:
        test_numpunct2()
            : IOv2::numeric_conf<wchar_t>("C")
...
void test_istream_extractors_arithmetic_wchar_t_6()
{
    dump_info("Test istream<wchar_t> operator>> (arithmetic) case 6...");
    auto helper = []<template<typename, typename> class T>()
    {
        // manufactured locale, grouping is turned on
        unsigned int h4 = 0, h3 = 0, h2 = 0;
        ...
        T is(IOv2::mem_device{s1}, IOv2::locale<wchar_t>("C"));
        is.locale(IOv2::locale<wchar_t>("C").involve(std::make_shared<test_numpunct2>()));
...
void test_istream_extractors_arithmetic_wchar_t_7()
{
    dump_info("Test istream<wchar_t> operator>> (arithmetic) case 7...");
    auto helper = []<template<typename, typename> class T>()
    {
        std::wstring st(L"2.456e3-+0.567e-2");
        T is(IOv2::mem_device{st}, IOv2::locale<wchar_t>("C"));
...
void test_istream_extractors_arithmetic_wchar_t_8()
{
    dump_info("Test istream<wchar_t> operator>> (arithmetic) case 8...");
    auto helper = []<template<typename, typename> class T>()
    {
        std::wstring str_01(L"0 00 000 +0 +0 -0");
        T is_01{IOv2::mem_device{str_01}, IOv2::locale<wchar_t>("C")};
        int n = 365;
        is_01 >> n;
        VERIFY(n == 0);
        n = 364;
        ...
        T is_03{IOv2::mem_device{str_02}, IOv2::locale<wchar_t>("C")};
        wchar_t c;
        int m;
        ...
        T is_05{IOv2::mem_device{str_05}, IOv2::locale<wchar_t>("C")};
        is_05 >> f;
        VERIFY(f == 0);
        f = 1;
        is_05 >> f;
...
void test_istream_extractors_arithmetic_wchar_t_9()
{
    dump_info("Test istream<wchar_t> operator>> (arithmetic) case 9...");
    auto helper = []<template<typename, typename> class T>()
    {
        ...
        T iss(IOv2::mem_device{cstrlit}, IOv2::locale<wchar_t>("C"));
...
void test_istream_extractors_arithmetic_wchar_t_10()
{
    dump_info("Test istream<wchar_t> operator>> (arithmetic) case 10...");
...
void test_istream_extractors_arithmetic_wchar_t_11()
{
    dump_info("Test istream<wchar_t> operator>> (arithmetic) case 11...");
    auto helper = []<template<typename, typename> class T>()
    {
        ...
        // used to core.
        double d;
        T iss1(IOv2::mem_device{l2}, IOv2::locale<wchar_t>("C"));
        iss1 >> d;
        iss1 >> d;
...
{
    dump_info("Test istream<wchar_t> operator>> (arithmetic) case 12...");
    auto helper = []<template<typename, typename> class T>()
    {
        T is{IOv2::mem_device{L"hello"}, IOv2::locale<wchar_t>("C")};
...
{
    dump_info("Test istream<wchar_t> operator>> (arithmetic) case 13...");

    auto helper = []<template<typename, typename> class T>()
    {
        short s1 = 0;
        IOv2::ostream oss1{IOv2::mem_device{L""}, IOv2::locale<wchar_t>("C")};
        ...
        short s2 = 0;
        IOv2::ostream oss2{IOv2::mem_device{L""}, IOv2::locale<wchar_t>("C")};
        ...
        short s3 = 0;
        IOv2::ostream oss3{IOv2::mem_device{L""}, IOv2::locale<wchar_t>("C")};
        ...
        short s4 = 0;
        IOv2::ostream oss4{IOv2::mem_device{L""}, IOv2::locale<wchar_t>("C")};
        ...
        int i1 = 0;
        IOv2::ostream oss5{IOv2::mem_device{L""}, IOv2::locale<wchar_t>("C")};
        ...
        int i2 = 0;
        IOv2::ostream oss6{IOv2::mem_device{L""}, IOv2::locale<wchar_t>("C")};
        ...
        int i3 = 0;
        IOv2::ostream oss7{IOv2::mem_device{L""}, IOv2::locale<wchar_t>("C")};
        ...
        int i4 = 0;
        IOv2::ostream oss8{IOv2::mem_device{L""}, IOv2::locale<wchar_t>("C")};
...
void test_istream_extractors_arithmetic_wchar_t_14()
{
    ...
    {
        int i = 0;
        T iss{IOv2::mem_device{L" 43"}, IOv2::locale<wchar_t>("C")};
        iss >> IOv2::noskipws >> i;
        VERIFY(!iss);
    };
