...
{
    test_istream_ignore_char_1();
    test_istream_ignore_char_2();
    test_istream_ignore_char_3();
    test_istream_ignore_char_4();
    test_istream_ignore_char_5();
    test_istream_ignore_char_6();
    test_istream_ignore_char_7();
    test_istream_ignore_char_8();
    test_istream_ignore_char_9();

    test_istream_ignore_wchar_t_1();
    test_istream_ignore_wchar_t_2();
    test_istream_ignore_wchar_t_3();
    test_istream_ignore_wchar_t_4();
    test_istream_ignore_wchar_t_5();
    test_istream_ignore_wchar_t_6();
    test_istream_ignore_wchar_t_7();
    test_istream_ignore_wchar_t_8();
    test_istream_ignore_wchar_t_9();
}