...
void test_istream_peek()
{
    test_istream_peek_char_1();
    test_istream_peek_char_2();
    test_istream_peek_char_3();
    test_istream_peek_char_4();

    test_istream_peek_wchar_t_1();
    test_istream_peek_wchar_t_2();
    test_istream_peek_wchar_t_3();
    test_istream_peek_wchar_t_4();
}