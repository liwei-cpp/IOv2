...
{
    test_istream_read_char_1();
    test_istream_read_char_2();
    test_istream_read_char_3();
    ...
    test_istream_read_wchar_t_3();
    test_istream_read_wchar_t_4();
    test_istream_read_wchar_t_5();
}