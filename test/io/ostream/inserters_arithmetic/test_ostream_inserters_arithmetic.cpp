...
{
    test_ostream_inserters_arithmetic_char_1();
    test_ostream_inserters_arithmetic_char_2();
    test_ostream_inserters_arithmetic_char_3();
    test_ostream_inserters_arithmetic_char_4();
    test_ostream_inserters_arithmetic_char_5();
    test_ostream_inserters_arithmetic_char_6();
    test_ostream_inserters_arithmetic_char_7();
    test_ostream_inserters_arithmetic_char_8();
    ...
    test_ostream_inserters_arithmetic_wchar_t_3();
    test_ostream_inserters_arithmetic_wchar_t_4();
    test_ostream_inserters_arithmetic_wchar_t_5();
    test_ostream_inserters_arithmetic_wchar_t_6();
    test_ostream_inserters_arithmetic_wchar_t_7();
    test_ostream_inserters_arithmetic_wchar_t_8();
