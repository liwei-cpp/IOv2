...
void test_ostream_inserters_arithmetic_char_1()
{
    dump_info("Test ostream<char> operator<< (arithmetic) case 1...");
    auto helper = []<template<typename, typename> class T>()
    {
        for (std::size_t j = 0; j<sizeof(testcases)/sizeof(testcases[0]); j++)
        {
            _TestCase & tc = testcases[j];
            IOv2::locale<char> loc = IOv2::locale<char>("C").involve(std::make_shared<testpunct<char>>(tc.decimal));
...
void test_ostream_inserters_arithmetic_char_2()
{
    dump_info("Test ostream<char> operator<< (arithmetic) case 2...");
    ...
    auto helper = []<template<typename, typename> class T>()
    {
        ...
        IOv2::locale<char> loc2("de_DE.ISO-8859-1");
        os2.locale(loc2);
...
void test_ostream_inserters_arithmetic_char_3()
{
...
void test_ostream_inserters_arithmetic_char_4()
{
    dump_info("Test ostream<char> operator<< (arithmetic) case 4...");
...
void test_ostream_inserters_arithmetic_char_5()
{
    dump_info("Test ostream<char> operator<< (arithmetic) case 5...");
...
void test_ostream_inserters_arithmetic_char_6()
{
    dump_info("Test ostream<char> operator<< (arithmetic) case 6...");
...
void test_ostream_inserters_arithmetic_char_7()
{
    dump_info("Test ostream<char> operator<< (arithmetic) case 7...");
...
void test_ostream_inserters_arithmetic_char_8()
{
    dump_info("Test ostream<char> operator<< (arithmetic) case 8...");
...
{
    dump_info("Test ostream<char> operator<< (arithmetic) case 9...");
...
{
    dump_info("Test ostream<char> operator<< (arithmetic) case 10...");
...
{
    dump_info("Test ostream<char> operator<< (arithmetic) case 11...");
