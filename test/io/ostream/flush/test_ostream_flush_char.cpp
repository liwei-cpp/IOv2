...
static_assert(std::is_copy_constructible_v<decltype(IOv2::iostream(IOv2::mem_device<char>{}))>,
...
void test_ostream_flush_char_2()
{
    dump_info("Test ostream<char>::flush case 2 (tie-cycle reentrancy)...");
...
void test_ostream_flush_char_3()
{
    dump_info("Test ostream<char>::flush case 3 (concurrent flush contention)...");
