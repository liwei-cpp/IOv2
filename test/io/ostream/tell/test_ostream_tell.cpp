...
{
    test_ostream_tell_char_1();
    test_ostream_tell_char_2();
    test_ostream_tell_char_3();

    test_ostream_tell_wchar_t_1();
    test_ostream_tell_wchar_t_2();
    test_ostream_tell_wchar_t_3();
}