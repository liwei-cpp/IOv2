...
void test_ostream_ends_wchar_t_1()
{
    dump_info("Test ostream<wchar_t> with ends case 1...");

    auto helper = []<template<typename, typename> class T>()
    {
        const std::string str01(" santa barbara ");
        auto oss01 = T(IOv2::mem_device{L" santa barbara "});
...
void test_ostream_ends_wchar_t_2()
{
    dump_info("Test ostream<wchar_t> with ends case 2...");

    auto helper = []<template<typename, typename> class T>()
    {
        auto osst_01 = T(IOv2::mem_device{L""});
        const std::wstring str_00(L"herbie_hancock");
        ...
        const std::wstring str_01(L"speak like a child");
        ...
        const std::wstring str_02(L"+ inventions and dimensions");
