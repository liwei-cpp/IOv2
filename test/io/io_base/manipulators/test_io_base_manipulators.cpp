...
{
    test_io_base_manipulators_adjustfield_char_1();
    test_io_base_manipulators_adjustfield_char_2();
    test_io_base_manipulators_adjustfield_wchar_t_1();
    test_io_base_manipulators_adjustfield_wchar_t_2();

    test_io_base_manipulators_basefield_char_1();
    test_io_base_manipulators_basefield_wchar_t_1();

    test_io_base_manipulators_setbase_char_1();
    test_io_base_manipulators_setbase_char_2();
    test_io_base_manipulators_setbase_char_3();
    test_io_base_manipulators_setbase_char_4();
    test_io_base_manipulators_setbase_wchar_t_1();

    test_io_base_manipulators_setw_char_1();
    test_io_base_manipulators_setw_char_2();
    ...
    test_io_base_manipulators_put_money_char_3();
    test_io_base_manipulators_put_money_wchar_t_1();
    test_io_base_manipulators_put_money_wchar_t_2();
    ...
    test_io_base_manipulators_get_money_wchar_t_1();
