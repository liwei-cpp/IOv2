...
void test_streambuf()
{
    test_streambuf_char_gen_1();
    test_streambuf_char_gen_2();
    test_streambuf_char_gen_3();
    test_streambuf_char_get1();
    test_streambuf_char_get2();
    test_streambuf_char_get3();
    test_streambuf_char_get4();
    test_streambuf_char_get5();
    test_streambuf_char_get6();
    test_streambuf_char_get7();
    test_streambuf_char_get8();

    test_streambuf_char_putback_1();
    test_streambuf_char_put1();
    test_streambuf_char_seek_1();
    test_streambuf_char_io_switch_1();
    test_streambuf_char_io_switch_2();
    test_streambuf_char_io_switch_3();
    test_streambuf_char_io_switch_4();
    test_streambuf_char_direction_1();
