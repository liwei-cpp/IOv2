...
void test_timeio_char32_t_get_1()
{
    ...
    VERIFY(CheckGet<year_month_day>(obj, U"20 01 01", U"%C %m %d", IOv2::ios_defs::eofbit) == year_month_day{std::chrono::year{2000}, std::chrono::month{1}, std::chrono::day{1}});
    dump_info("Done\n");
}
...
void test_timeio_char32_t_get_9()
{
    ...
    // POSIX strptime -- not the wall-clock year, and not whatever the parse context
    // happens to fall back to.
    VERIFY(FYmd(U"20 01 01", U"%C %m %d", IOv2::ios_defs::eofbit) == year_month_day{std::chrono::year{2000}, std::chrono::month{1}, std::chrono::day{1}});
