...
void test_timeio_wchar_t_put_2()
{
    ...
    {
        res.clear(); obj.put(std::back_inserter(res), tp, L'c');
        VERIFY(res == L"2024年09月04日 星期三 13时33分18秒");
        res.clear(); obj.put(std::back_inserter(res), tp, L'c', L'E');
        VERIFY(res == L"2024年09月04日 星期三 13时33分18秒");
        res.clear(); obj.put(std::back_inserter(res), tp, L'c', L'O');
        VERIFY(res == L"%Oc");
...
void test_timeio_wchar_t_put_3()
{
    ...
    {
        res.clear(); obj.put(std::back_inserter(res), tp, L'c');
        VERIFY(res == L"2024年09月04日 13時33分18秒");
        res.clear(); obj.put(std::back_inserter(res), tp, L'c', L'E');
        VERIFY(res == L"令和6年09月04日 13時33分18秒");
        res.clear(); obj.put(std::back_inserter(res), tp, L'c', L'O');
        VERIFY(res == L"%Oc");
    }
...
void test_timeio_wchar_t_put_4()
{
...

    {
        ...
        VERIFY(oss == L"04/04/71");
    }

    {
        oss.clear();
        obj.put(std::back_inserter(oss), time1, L'X');
        VERIFY(oss == L"12:00:00");
    }
...
void test_timeio_wchar_t_put_6()
{
    ...
    {
        oss.clear(); obj.put(std::back_inserter(oss), time1, L'x');
        VERIFY(oss == L"Sunday, April 04, 1971");
    }
    {
        oss.clear(); obj.put(std::back_inserter(oss), time1, L'X');
        VERIFY(oss.find(L"12:00:00") != std::wstring::npos);
    }
    {
        oss.clear(); obj.put(std::back_inserter(oss), time1, L'x', L'E');
        VERIFY(oss == L"Sunday, April 04, 1971");
...
void test_timeio_wchar_t_put_8()
{
    ...
    std::wstring oss, oss2;
    {
        ...
        VERIFY(oss == L"Sunday, the second of April");
    }
    {
...
void test_timeio_wchar_t_put_9()
{
    ...
    {
        obj.put(std::back_inserter(oss), time1, date);
        VERIFY(oss == L"Sonntag, the second of April");
    }
    {
        obj.put(std::back_inserter(oss2), time1, date_ex);
        VERIFY(oss != oss2);
...
void test_timeio_wchar_t_put_11()
{
    ...
    {
        obj.put(std::back_inserter(oss), time1, date);
        VERIFY(oss == L"dimanche, the second of avril");
    }
    {
        obj.put(std::back_inserter(oss2), time1, date_ex);
        VERIFY(oss != oss2);
...
void test_timeio_wchar_t_put_12()
{
    ...
    VERIFY(res == L"12:00:00, Thursday, the second of June, 1997xxxxxx");
    VERIFY(sanity1 == L"12:00:00, Thursday, the second of June, 1997");
...
void test_timeio_wchar_t_put_14()
{
    ...
    VERIFY(IOv2::detail::to_wstring(time_buffer, "ta_IN.UTF-8") == res);
...
void test_timeio_wchar_t_put_17()
{
...

    {
        ...
        res.clear(); obj.put(std::back_inserter(res), tp, L'Z'); VERIFY(res == L"UNKNOWN");
        res.clear(); obj.put(std::back_inserter(res), tp, L'Z', L'E');
        VERIFY(res == L"%EZ");
        res.clear(); obj.put(std::back_inserter(res), tp, L'Z', L'O');
        VERIFY(res == L"%OZ");
        ...
        std::tm named = tp;
        named.tm_zone = "PST";
        res.clear(); obj.put(std::back_inserter(res), named, L'Z'); VERIFY(res == L"PST");

        // An empty string is as nameless as a null pointer.
        named.tm_zone = "";
        res.clear(); obj.put(std::back_inserter(res), named, L'Z'); VERIFY(res == L"UNKNOWN");
#endif
    }

    {
        res.clear(); obj.put(std::back_inserter(res), tp, L'z'); VERIFY(res == L"+0000");
        res.clear(); obj.put(std::back_inserter(res), tp, L'z', L'E');
        VERIFY(res == L"%Ez");
        res.clear(); obj.put(std::back_inserter(res), tp, L'z', L'O');
        VERIFY(res == L"%Oz");
...
namespace
{
    ...
    template <typename T = IOv2::time_parse_context<wchar_t>, bool HaveDate = true, bool HaveTime = true, IOv2::tz_level TzLevel = IOv2::tz_level::zone>
               ...
               IOv2::ios_defs::iostate err_exp, size_t consume_exp = (size_t)-1)
    {
        ...
        IOv2::time_parse_context<wchar_t, HaveDate, HaveTime, TzLevel> ctx1, ctx2, ctx3;
...
void test_timeio_wchar_t_get_1()
{
    ...
    using namespace std::chrono;
    VERIFY(CheckGet<year_month_day>(obj, L"Wed Sep  4 13:33:18 2024", L'c', 0, IOv2::ios_defs::eofbit) == check_date1);
    VERIFY(CheckGet<year_month_day>(obj, L"Wed Sep  4 13:33:18 2024", L'c', L'E', IOv2::ios_defs::eofbit, 17) == check_date1);
    ...
    VERIFY(CheckGet<std::chrono::hh_mm_ss<std::chrono::seconds>>(obj, L"13:33:18", L"%X",  IOv2::ios_defs::eofbit).to_duration()
           == std::chrono::hh_mm_ss<std::chrono::seconds>{std::chrono::hours{13} + std::chrono::minutes{33} + std::chrono::seconds{18}}.to_duration());
    VERIFY(CheckGet<std::chrono::hh_mm_ss<std::chrono::seconds>>(obj, L"13:33:18", L"%EX",  IOv2::ios_defs::eofbit).to_duration()
           == std::chrono::hh_mm_ss<std::chrono::seconds>{std::chrono::hours{13} + std::chrono::minutes{33} + std::chrono::seconds{18}}.to_duration());
    CheckGet(obj, L"X",   L'X', L'E', IOv2::ios_defs::strfailbit, 0);
    CheckGet(obj, L"%OX", L'X', L'O', IOv2::ios_defs::eofbit);
    CheckGet(obj, L"X",   L'X', L'O', IOv2::ios_defs::strfailbit, 0);
    ...
    VERIFY(zone_is(CheckGet(obj, L"America/Los_Angeles", L'Z', 0, IOv2::ios_defs::eofbit).m_zone_name, "America/Los_Angeles"));
    VERIFY(CheckGet(obj, L"PST", L'Z', 0, IOv2::ios_defs::eofbit).m_zone_name == nullptr);
    ...
    VERIFY(CheckGet<year_month_day>(obj, L"20 01 01", L"%C %m %d", IOv2::ios_defs::eofbit) == year_month_day{std::chrono::year{2000}, std::chrono::month{1}, std::chrono::day{1}});
    dump_info("Done\n");
}
...
void test_timeio_wchar_t_get_2()
{
    ...
    using namespace std::chrono;
    VERIFY(CheckGet<year_month_day>(obj, L"2024年09月04日 星期三 13时33分18秒", L'c', 0, IOv2::ios_defs::eofbit) == check_date1);
    VERIFY(CheckGet<year_month_day>(obj, L"2024年09月04日 星期三 13时33分18秒", L'c', L'E', IOv2::ios_defs::eofbit) == check_date1);
    CheckGet(obj, L"c",   L'c', L'E', IOv2::ios_defs::strfailbit, 0);
    CheckGet(obj, L"%Oc", L'c', L'O', IOv2::ios_defs::eofbit);
    CheckGet(obj, L"c",   L'c', L'O', IOv2::ios_defs::strfailbit, 0);
    ...
    VERIFY(CheckGet<std::chrono::hh_mm_ss<std::chrono::seconds>>(obj, L"13时33分18秒", L"%X",  IOv2::ios_defs::eofbit).to_duration()
           == std::chrono::hh_mm_ss<std::chrono::seconds>{std::chrono::hours{13} + std::chrono::minutes{33} + std::chrono::seconds{18}}.to_duration());
    VERIFY(CheckGet<std::chrono::hh_mm_ss<std::chrono::seconds>>(obj, L"13时33分18秒", L"%EX",  IOv2::ios_defs::eofbit).to_duration()
           == std::chrono::hh_mm_ss<std::chrono::seconds>{std::chrono::hours{13} + std::chrono::minutes{33} + std::chrono::seconds{18}}.to_duration());
    CheckGet(obj, L"X",   L'X', L'E', IOv2::ios_defs::strfailbit, 0);
    CheckGet(obj, L"%OX", L'X', L'O', IOv2::ios_defs::eofbit);
    CheckGet(obj, L"X",   L'X', L'O', IOv2::ios_defs::strfailbit, 0);
...
void test_timeio_wchar_t_get_3()
{
    ...
    using namespace std::chrono;
    VERIFY(CheckGet<year_month_day>(obj, L"2024年09月04日 13時33分18秒", L'c', 0, IOv2::ios_defs::eofbit) == check_date1);
    VERIFY(CheckGet<year_month_day>(obj, L"令和6年09月04日 13時33分18秒", L'c', L'E', IOv2::ios_defs::eofbit) == check_date1);
    VERIFY(CheckGet<year_month_day>(obj, L"202409月04日 13時33分18秒", L'c', L'E', IOv2::ios_defs::eofbit) == check_date1);
    CheckGet(obj, L"c",   L'c', L'E', IOv2::ios_defs::strfailbit, 0);
    CheckGet(obj, L"%Oc", L'c', L'O', IOv2::ios_defs::eofbit);
    CheckGet(obj, L"c",   L'c', L'O', IOv2::ios_defs::strfailbit, 0);
    ...
    VERIFY(CheckGet<std::chrono::hh_mm_ss<std::chrono::seconds>>(obj, L"13時33分18秒", L"%X",  IOv2::ios_defs::eofbit).to_duration()
           == std::chrono::hh_mm_ss<std::chrono::seconds>{std::chrono::hours{13} + std::chrono::minutes{33} + std::chrono::seconds{18}}.to_duration());
    VERIFY(CheckGet<std::chrono::hh_mm_ss<std::chrono::seconds>>(obj, L"13時33分18秒", L"%EX",  IOv2::ios_defs::eofbit).to_duration()
           == std::chrono::hh_mm_ss<std::chrono::seconds>{std::chrono::hours{13} + std::chrono::minutes{33} + std::chrono::seconds{18}}.to_duration());
    CheckGet(obj, L"X",   L'X', L'E', IOv2::ios_defs::strfailbit, 0);
    CheckGet(obj, L"%OX", L'X', L'O', IOv2::ios_defs::eofbit);
    CheckGet(obj, L"X",   L'X', L'O', IOv2::ios_defs::strfailbit, 0);
...
void test_timeio_wchar_t_get_9()
{
    ...
    {
        return CheckGet<IOv2::time_parse_context<wchar_t, true, true, IOv2::tz_level::none>, true, true, IOv2::tz_level::none>(obj, std::forward<decltype(args)>(args)...);
    };
    ...
    // POSIX strptime -- not the wall-clock year, and not whatever the parse context
    // happens to fall back to.
    VERIFY(FYmd(L"20 01 01", L"%C %m %d", IOv2::ios_defs::eofbit) == year_month_day{std::chrono::year{2000}, std::chrono::month{1}, std::chrono::day{1}});
...
void test_timeio_wchar_t_get_10()
{
    ...
    auto FOri = [&obj](auto&&... args)
    {
        return CheckGet<IOv2::time_parse_context<wchar_t, true, false, IOv2::tz_level::none>, true, false, IOv2::tz_level::none>(obj, std::forward<decltype(args)>(args)...);
    };
...
void test_timeio_wchar_t_get_11()
{
    ...
    auto FOri = [&obj](auto&&... args)
    {
        return CheckGet<IOv2::time_parse_context<wchar_t, false, true, IOv2::tz_level::zone>, false, true, IOv2::tz_level::zone>(obj, std::forward<decltype(args)>(args)...);
    };
    ...
    VERIFY(zone_is(FOri(L"America/Los_Angeles", L'Z', 0, IOv2::ios_defs::eofbit).m_zone_name, "America/Los_Angeles"));
    VERIFY(FOri(L"PST", L'Z', 0, IOv2::ios_defs::eofbit).m_zone_name == nullptr);
    ...
    { auto r = FOri(L"+0800", L'z', 0, IOv2::ios_defs::eofbit); VERIFY(r.m_have_offset && r.m_offset == minutes{480}); }
    FOri(L"%z", L'z', 0, IOv2::ios_defs::strfailbit);
    FOri(L"%Ez", L'z', L'E', IOv2::ios_defs::eofbit);
    FOri(L"z",  L'z', L'E', IOv2::ios_defs::strfailbit, 0);
    FOri(L"%Oz", L'z', L'O', IOv2::ios_defs::eofbit);
    FOri(L"z",  L'z', L'O', IOv2::ios_defs::strfailbit, 0);
...
void test_timeio_wchar_t_get_12()
{
    ...
    auto FOri = [&obj](auto&&... args)
    {
        return CheckGet<IOv2::time_parse_context<wchar_t, false, true, IOv2::tz_level::none>, false, true, IOv2::tz_level::none>(obj, std::forward<decltype(args)>(args)...);
    };
...
{
    dump_info("Test timeio<wchar_t> get 13...");

    IOv2::timeio obj(std::make_shared<IOv2::timeio_conf<wchar_t>>("C"));

    auto off_ok = [&obj](const std::wstring& in, const wchar_t* fmt)
    {
        IOv2::time_parse_context<wchar_t, true, true, IOv2::tz_level::offset> ctx;
    ...
    {
        IOv2::time_parse_context<wchar_t, true, true, IOv2::tz_level::zone> ctx;
        try { return obj.get(in.begin(), in.end(), ctx, std::wstring_view(fmt)) == in.end(); }
        catch (IOv2::stream_error&) { return false; }
    };
    ...
    VERIFY(zone_ok(L"UTC", L"%Z"));
    VERIFY(zone_ok(L"PDT", L"%Z"));
    VERIFY(zone_ok(L"CEST", L"%Z"));
    VERIFY(zone_ok(L"EWT", L"%Z"));
    ...
    VERIFY(off_ok(L"%Z", L"%Z"));
    VERIFY(!zone_ok(L"%Z", L"%Z"));
    VERIFY(!off_ok(L"%z", L"%Z"));
