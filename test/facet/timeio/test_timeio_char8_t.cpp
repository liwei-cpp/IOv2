...
void test_timeio_char8_t_put_1()
{
...

    {
        ...
        VERIFY(res == u8"Wed Sep  4 13:33:18 2024");
...
void test_timeio_char8_t_put_2()
{
    ...
    {
        res.clear(); obj.put(std::back_inserter(res), tp, u8'c');
        VERIFY(res == u8"2024年09月04日 星期三 13时33分18秒");
        res.clear(); obj.put(std::back_inserter(res), tp, u8'c', u8'E');
        VERIFY(res == u8"2024年09月04日 星期三 13时33分18秒");
        res.clear(); obj.put(std::back_inserter(res), tp, u8'c', u8'O');
        VERIFY(res == u8"%Oc");
...
void test_timeio_char8_t_put_17()
{
...

    {
        ...
        res.clear(); obj.put(std::back_inserter(res), tp, u8'Z'); VERIFY(res == u8"UNKNOWN");
        res.clear(); obj.put(std::back_inserter(res), tp, u8'Z', u8'E');
        VERIFY(res == u8"%EZ");
        res.clear(); obj.put(std::back_inserter(res), tp, u8'Z', u8'O');
        VERIFY(res == u8"%OZ");
        ...
        std::tm named = tp;
        named.tm_zone = "PST";
        res.clear(); obj.put(std::back_inserter(res), named, u8'Z'); VERIFY(res == u8"PST");

        // An empty string is as nameless as a null pointer.
        named.tm_zone = "";
        res.clear(); obj.put(std::back_inserter(res), named, u8'Z'); VERIFY(res == u8"UNKNOWN");
#endif
    }

    {
        res.clear(); obj.put(std::back_inserter(res), tp, u8'z'); VERIFY(res == u8"+0000");
        res.clear(); obj.put(std::back_inserter(res), tp, u8'z', u8'E');
        VERIFY(res == u8"%Ez");
        res.clear(); obj.put(std::back_inserter(res), tp, u8'z', u8'O');
        VERIFY(res == u8"%Oz");
...
namespace
{
    ...
    template <typename T = IOv2::time_parse_context<char8_t>, bool HaveDate = true, bool HaveTime = true, IOv2::tz_level TzLevel = IOv2::tz_level::zone>
               ...
               IOv2::ios_defs::iostate err_exp, size_t consume_exp = (size_t)-1)
    {
        ...
        IOv2::time_parse_context<char8_t, HaveDate, HaveTime, TzLevel> ctx1, ctx2, ctx3;
...
void test_timeio_char8_t_get_1()
{
    ...
    using namespace std::chrono;
    VERIFY(CheckGet<year_month_day>(obj, u8"Wed Sep  4 13:33:18 2024", u8'c', 0, IOv2::ios_defs::eofbit) == check_date1);
    VERIFY(CheckGet<year_month_day>(obj, u8"Wed Sep  4 13:33:18 2024", u8'c', u8'E', IOv2::ios_defs::eofbit, 17) == check_date1);
    ...
    VERIFY(CheckGet<std::chrono::hh_mm_ss<std::chrono::seconds>>(obj, u8"13:33:18", u8"%X",  IOv2::ios_defs::eofbit).to_duration()
           == std::chrono::hh_mm_ss<std::chrono::seconds>{std::chrono::hours{13} + std::chrono::minutes{33} + std::chrono::seconds{18}}.to_duration());
    VERIFY(CheckGet<std::chrono::hh_mm_ss<std::chrono::seconds>>(obj, u8"13:33:18", u8"%EX",  IOv2::ios_defs::eofbit).to_duration()
           == std::chrono::hh_mm_ss<std::chrono::seconds>{std::chrono::hours{13} + std::chrono::minutes{33} + std::chrono::seconds{18}}.to_duration());
    CheckGet(obj, u8"X",   u8'X', u8'E', IOv2::ios_defs::strfailbit, 0);
    CheckGet(obj, u8"%OX", u8'X', u8'O', IOv2::ios_defs::eofbit);
    CheckGet(obj, u8"X",   u8'X', u8'O', IOv2::ios_defs::strfailbit, 0);
    ...
    VERIFY(zone_is(CheckGet(obj, u8"America/Los_Angeles", u8'Z', 0, IOv2::ios_defs::eofbit).m_zone_name, "America/Los_Angeles"));
    VERIFY(CheckGet(obj, u8"PST", u8'Z', 0, IOv2::ios_defs::eofbit).m_zone_name == nullptr);
...
void test_timeio_char8_t_get_2()
{
    ...
    using namespace std::chrono;
    VERIFY(CheckGet<year_month_day>(obj, u8"2024年09月04日 星期三 13时33分18秒", u8'c', 0, IOv2::ios_defs::eofbit) == check_date1);
    VERIFY(CheckGet<year_month_day>(obj, u8"2024年09月04日 星期三 13时33分18秒", u8'c', u8'E', IOv2::ios_defs::eofbit) == check_date1);
    CheckGet(obj, u8"c",   u8'c', u8'E', IOv2::ios_defs::strfailbit, 0);
    CheckGet(obj, u8"%Oc", u8'c', u8'O', IOv2::ios_defs::eofbit);
    CheckGet(obj, u8"c",   u8'c', u8'O', IOv2::ios_defs::strfailbit, 0);
    ...
    VERIFY(CheckGet<std::chrono::hh_mm_ss<std::chrono::seconds>>(obj, u8"13时33分18秒", u8"%X",  IOv2::ios_defs::eofbit).to_duration()
           == std::chrono::hh_mm_ss<std::chrono::seconds>{std::chrono::hours{13} + std::chrono::minutes{33} + std::chrono::seconds{18}}.to_duration());
    VERIFY(CheckGet<std::chrono::hh_mm_ss<std::chrono::seconds>>(obj, u8"13时33分18秒", u8"%EX",  IOv2::ios_defs::eofbit).to_duration()
           == std::chrono::hh_mm_ss<std::chrono::seconds>{std::chrono::hours{13} + std::chrono::minutes{33} + std::chrono::seconds{18}}.to_duration());
    CheckGet(obj, u8"X",   u8'X', u8'E', IOv2::ios_defs::strfailbit, 0);
    CheckGet(obj, u8"%OX", u8'X', u8'O', IOv2::ios_defs::eofbit);
    CheckGet(obj, u8"X",   u8'X', u8'O', IOv2::ios_defs::strfailbit, 0);
...
void test_timeio_char8_t_get_3()
{
    ...
    using namespace std::chrono;
    VERIFY(CheckGet<year_month_day>(obj, u8"2024年09月04日 13時33分18秒", u8'c', 0, IOv2::ios_defs::eofbit) == check_date1);
    VERIFY(CheckGet<year_month_day>(obj, u8"令和6年09月04日 13時33分18秒", u8'c', u8'E', IOv2::ios_defs::eofbit) == check_date1);
    VERIFY(CheckGet<year_month_day>(obj, u8"202409月04日 13時33分18秒", u8'c', u8'E', IOv2::ios_defs::eofbit) == check_date1);
    CheckGet(obj, u8"c",   u8'c', u8'E', IOv2::ios_defs::strfailbit, 0);
    CheckGet(obj, u8"%Oc", u8'c', u8'O', IOv2::ios_defs::eofbit);
    CheckGet(obj, u8"c",   u8'c', u8'O', IOv2::ios_defs::strfailbit, 0);
    ...
    VERIFY(CheckGet<std::chrono::hh_mm_ss<std::chrono::seconds>>(obj, u8"13時33分18秒", u8"%X",  IOv2::ios_defs::eofbit).to_duration()
           == std::chrono::hh_mm_ss<std::chrono::seconds>{std::chrono::hours{13} + std::chrono::minutes{33} + std::chrono::seconds{18}}.to_duration());
    VERIFY(CheckGet<std::chrono::hh_mm_ss<std::chrono::seconds>>(obj, u8"13時33分18秒", u8"%EX",  IOv2::ios_defs::eofbit).to_duration()
           == std::chrono::hh_mm_ss<std::chrono::seconds>{std::chrono::hours{13} + std::chrono::minutes{33} + std::chrono::seconds{18}}.to_duration());
    CheckGet(obj, u8"X",   u8'X', u8'E', IOv2::ios_defs::strfailbit, 0);
    CheckGet(obj, u8"%OX", u8'X', u8'O', IOv2::ios_defs::eofbit);
    CheckGet(obj, u8"X",   u8'X', u8'O', IOv2::ios_defs::strfailbit, 0);
...
void test_timeio_char8_t_get_9()
{
    ...
    {
        return CheckGet<IOv2::time_parse_context<char8_t, true, true, IOv2::tz_level::none>, true, true, IOv2::tz_level::none>(obj, std::forward<decltype(args)>(args)...);
    };
...
void test_timeio_char8_t_get_10()
{
    ...
    auto FOri = [&obj](auto&&... args)
    {
        return CheckGet<IOv2::time_parse_context<char8_t, true, false, IOv2::tz_level::none>, true, false, IOv2::tz_level::none>(obj, std::forward<decltype(args)>(args)...);
    };
...
void test_timeio_char8_t_get_11()
{
    ...
    auto FOri = [&obj](auto&&... args)
    {
        return CheckGet<IOv2::time_parse_context<char8_t, false, true, IOv2::tz_level::zone>, false, true, IOv2::tz_level::zone>(obj, std::forward<decltype(args)>(args)...);
    };
    ...
    VERIFY(zone_is(FOri(u8"America/Los_Angeles", u8'Z', 0, IOv2::ios_defs::eofbit).m_zone_name, "America/Los_Angeles"));
    VERIFY(FOri(u8"PST", u8'Z', 0, IOv2::ios_defs::eofbit).m_zone_name == nullptr);
    ...
    { auto r = FOri(u8"+0800", u8'z', 0, IOv2::ios_defs::eofbit); VERIFY(r.m_have_offset && r.m_offset == minutes{480}); }
    FOri(u8"%z", u8'z', 0, IOv2::ios_defs::strfailbit);
    FOri(u8"%Ez", u8'z', u8'E', IOv2::ios_defs::eofbit);
    FOri(u8"z",  u8'z', u8'E', IOv2::ios_defs::strfailbit, 0);
    FOri(u8"%Oz", u8'z', u8'O', IOv2::ios_defs::eofbit);
    FOri(u8"z",  u8'z', u8'O', IOv2::ios_defs::strfailbit, 0);
...
void test_timeio_char8_t_get_12()
{
    ...
    auto FOri = [&obj](auto&&... args)
    {
        return CheckGet<IOv2::time_parse_context<char8_t, false, true, IOv2::tz_level::none>, false, true, IOv2::tz_level::none>(obj, std::forward<decltype(args)>(args)...);
    };
...
{
    dump_info("Test timeio<char8_t> get 13...");

    IOv2::timeio obj(std::make_shared<IOv2::timeio_conf<char8_t>>("C"));

    auto off_ok = [&obj](const std::u8string& in, const char8_t* fmt)
    {
        IOv2::time_parse_context<char8_t, true, true, IOv2::tz_level::offset> ctx;
    ...
    {
        IOv2::time_parse_context<char8_t, true, true, IOv2::tz_level::zone> ctx;
        try { return obj.get(in.begin(), in.end(), ctx, std::u8string_view(fmt)) == in.end(); }
        catch (IOv2::stream_error&) { return false; }
    };
    ...
    VERIFY(zone_ok(u8"UTC", u8"%Z"));
    VERIFY(zone_ok(u8"PDT", u8"%Z"));
    VERIFY(zone_ok(u8"CEST", u8"%Z"));
    VERIFY(zone_ok(u8"EWT", u8"%Z"));
    VERIFY(zone_ok(u8"America/Los_Angeles", u8"%Z"));
    VERIFY(!zone_ok(u8"XYZ", u8"%Z"));

    VERIFY(off_ok(u8"PDT", u8"%Z"));
    VERIFY(off_ok(u8"America/Los_Angeles", u8"%Z"));
    VERIFY(!off_ok(u8"XYZ", u8"%Z"));

    // The literal %Z, which is what put writes when the value has no zone to offer.
    VERIFY(off_ok(u8"%Z", u8"%Z"));
    VERIFY(!zone_ok(u8"%Z", u8"%Z"));
    VERIFY(!off_ok(u8"%z", u8"%Z"));
