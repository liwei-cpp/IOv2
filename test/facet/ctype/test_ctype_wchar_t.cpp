...
void test_ctype_facet_wchar_t_1()
{
    ...
    VERIFY(IOv2::ctype_conf<wchar_t>::id() != IOv2::ctype_conf<char>::id());
...
void test_ctype_facet_wchar_t_2()
{
    ...
    VERIFY(obj.is_any(IOv2::base_ft<IOv2::ctype>::space, c30));
    VERIFY(obj.is_any(IOv2::base_ft<IOv2::ctype>::upper, c00));
    VERIFY(obj.is_any(IOv2::base_ft<IOv2::ctype>::lower, c10));
    VERIFY(obj.is_any(IOv2::base_ft<IOv2::ctype>::digit, c20));
    VERIFY(obj.is_any(IOv2::base_ft<IOv2::ctype>::punct, c40));
    VERIFY(obj.is_any(IOv2::base_ft<IOv2::ctype>::alpha, c50));
    VERIFY(obj.is_any(IOv2::base_ft<IOv2::ctype>::alpha, c60));
    VERIFY(obj.is_any(IOv2::base_ft<IOv2::ctype>::xdigit, c20));
    VERIFY(!(obj.is_any(IOv2::base_ft<IOv2::ctype>::xdigit, c80)));
    VERIFY(obj.is_any(IOv2::base_ft<IOv2::ctype>::alnum, c50));
    VERIFY(obj.is_any(IOv2::base_ft<IOv2::ctype>::alnum, c20));
    VERIFY(obj.is_any(IOv2::base_ft<IOv2::ctype>::graph, c40));
    VERIFY(obj.is_any(IOv2::base_ft<IOv2::ctype>::graph, c20));
    ...
    for (std::size_t i = 0; i < 3; ++i)
        m01[i] = m00;
    VERIFY(obj.is_seq(cc0, cc0, m01) == m01);
    VERIFY(!((m01[0] != m00) || (m01[1] != m00) || (m01[2] != m00)));

    cc0 = strlit00;
    for (std::size_t i = 0; i < 3; ++i)
        m01[i] = m00;
    VERIFY(obj.is_seq(cc0, cc0 + 3, m01) == m01 + 3);
    VERIFY(!((m01[0] == m00) || (m01[1] == m00) || (m01[2] == m00)));
    VERIFY(obj.is_any(m01[0], cc0[0]));
    VERIFY(obj.is_any(m01[1], cc0[1]));
    VERIFY(obj.is_any(m01[2], cc0[2]));

    cc0 = strlit01;
    for (std::size_t i = 0; i < 13; ++i)
        m02[i] = m00;
    VERIFY(obj.is_seq(cc0, cc0 + 13, m02) == m02 + 13);
    VERIFY(!((m02[6] == m00) || (m02[7] == m00) || (m02[8] == m00)));
    VERIFY(!((m02[8] == m02[6]) || (m02[7] == m02[6])));
    VERIFY((m02[6] & IOv2::base_ft<IOv2::ctype>::alnum));
    VERIFY((m02[6] & IOv2::base_ft<IOv2::ctype>::upper));
    VERIFY((m02[6] & IOv2::base_ft<IOv2::ctype>::alpha));
    VERIFY((m02[7] & IOv2::base_ft<IOv2::ctype>::punct));
    VERIFY((m02[8] & IOv2::base_ft<IOv2::ctype>::space));
    
    VERIFY(obj.is_any(m02[6], cc0[6]));
    VERIFY(obj.is_any(m02[7], cc0[7]));
    VERIFY(obj.is_any(m02[8], cc0[8]));
...
void test_ctype_facet_wchar_t_5()
{
    ...
    VERIFY(narrow_chars.size() == wide.size());
...
void test_ctype_facet_wchar_t_7()
{
    ...
    VERIFY(buf[0] == obj.narrow(wstrlit[0], ' '));
    VERIFY(buf[1] == obj.narrow(wstrlit[1], ' '));
    dump_info("Done\n");
}
...
void test_ctype_facet_wchar_t_10()
{
    ...
    VERIFY(obj.tolower(L'Ａ') == L'ａ');
    VERIFY(obj.toupper(L'ａ') == L'Ａ');
